...
class Browser extends EventEmitter_js_1.EventEmitter {
    ...
    constructor(connection, contextIds, ignoreHTTPSErrors, defaultViewport, process, closeCallback, targetFilterCallback, isPageTargetCallback) {
        ...
        this._connection.on(Connection_js_1.ConnectionEmittedEvents.Disconnected, () => this.emit("disconnected" /* BrowserEmittedEvents.Disconnected */));
...
class BrowserContext extends EventEmitter_js_1.EventEmitter {
    ...
    async pages() {
        const pages = await Promise.all(this.targets()
            ...
            return target.type() === 'page' ||
                (target.type() === 'other' &&
                    ((_a = this._browser._getIsPageTargetCallback()) === null || _a === void 0 ? void 0 : _a(target._getTargetInfo())));
        })
