...
class Target {
    ...
    constructor(targetInfo, browserContext, sessionFactory, ignoreHTTPSErrors, defaultViewport, screenshotTaskQueue, isPageTargetCallback) {
        ...
        this._defaultViewport = defaultViewport !== null && defaultViewport !== void 0 ? defaultViewport : undefined;
    ...
    async page() {
        ...
        if (this._isPageTargetCallback(this._targetInfo) && !this._pagePromise) {
            this._pagePromise = this._sessionFactory().then((client) => {
                var _a;
                return Page_js_1.Page.create(client, this, this._ignoreHTTPSErrors, (_a = this._defaultViewport) !== null && _a !== void 0 ? _a : null, this._screenshotTaskQueue);
            });
        }
        return (_a = (await this._pagePromise)) !== null && _a !== void 0 ? _a : null;
    }
    /**
